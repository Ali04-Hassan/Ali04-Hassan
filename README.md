...
* **Tech:** AI Integration, JavaScript, Vercel
* **Description:** AI-powered study tool that converts notes into interactive quizzes and tracks weak topics.

#### 📊 [Student Grading System](https://github.com/Ali04-Hassan/Student-Grading-System)
* **Tech:** C++, HTML, CSS, JavaScript
* **Description:** A C++ based student grading system integrated with a modern web frontend dashboard for grade processing and tracking.

#### 🤖 [AI Automation & Agents Directory](https://github.com/Ali04-Hassan/Ai-automation-and-agents)
* **Tech:** n8n, Vapi, Gemini AI, Pinecone, Twilio, Shopify, Cognito Forms
* **Includes:**
  * **24/7 AI Voice & Chat Support:** Shopify order tracking, refund requests, and abandoned cart recovery.
  * **AI Lead Qualification & CRM Automation:** Automated scoring via Cognito Forms, Google Sheets, and Gmail alerts.
  * **RAG Knowledge Base:** Custom document Q&A using Pinecone vector database and Gemini AI.
  * **AI Invoice Processing:** Automated data extraction and validation from PDF email attachments.

---

### 🎨 Design & AI Innovation
* **Google Stitch & Lovable AI:** Rapid UI/UX prototyping and front-end layout generation.
* **NotebookLM & Claude:** Advanced context retrieval, prompt engineering, and deep logic orchestration.

---

### 📜 Certifications
* **ACT AI — National AI Training Programme** (HEC & NAVTTC)
* **Excel and Copilot Fundamentals** (Microsoft / Coursera)
